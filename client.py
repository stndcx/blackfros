...
Same wire protocol as the server: connects, optionally through Tor,
and speaks the line-based text protocol (OK/ERROR/SHOPS/SHOP/CHAT/DM/*).
Networking lives in network.py, colors/CSS live in theme.py - this
file is just the UI layout and glue.
"""
...
class BackfrosClient(App):
    ...
    def __init__(self, ip, port, use_tor=False,
        ...
        self.nickname = f"anon{id(self) % 1000}"
        self.shops = []
